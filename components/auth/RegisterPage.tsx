...
const RegisterPage: React.FC<RegisterPageProps> = ({ darkMode = false, toggleTheme = () => {} }) => {
  ...
  useEffect(() => {
    document.title = 'Register - Sports Dashboard | Match Watch | Follow Teams';
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Create a Sports Dashboard account to follow your favorite teams, get match notifications, and personalized sports updates.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Create a Sports Dashboard account to follow your favorite teams, get match notifications, and personalized sports updates.';
      document.head.appendChild(meta);
    }

    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'register, sign up, sports, dashboard, follow teams, match notifications, soccer, football');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = 'register, sign up, sports, dashboard, follow teams, match notifications, soccer, football';
      document.head.appendChild(meta);
    }
  }, []);
        ...
        <div className="max-w-md w-full space-y-8 bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-zinc-800">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Start following your favorite teams today
            </p>
          </div>
