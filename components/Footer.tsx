        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                  <Link to="/nba-all-star-2026" onClick={scrollToTop} className="text-xs text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-blue-300 transition-colors flex items-center gap-1 font-semibold text-blue-600 dark:text-blue-400">
                    NBA All-Star 2026
                  </Link>
              </li>
            </ul>
